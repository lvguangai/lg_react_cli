...
class requestMethod {
  ...
  private baseAxios({ baseURL = this.baseUrl, timeout = this.timeout, method, url, data, params, responseType, headers }: AxiosRequest): Promise<CustomResponse> {
  ...
  protected postReq({url, data, params, responseType, headers }: AxiosRequest):any {
      return this.baseAxios({method: 'POST', url, data, params, responseType, headers });
  }
  ...
  protected putReq({url, data, params, responseType, headers }: AxiosRequest):any {
      return this.baseAxios({method: 'PUT', url, data, params, responseType, headers });
  }
  ...
  protected deleteReq({url, data, params, responseType }: AxiosRequest):any {
      return this.baseAxios({method: 'DELETE', url, data, params, responseType });
  }
}
